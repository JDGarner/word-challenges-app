...
import { getPraiseForScore } from "../synonyms-utils";
...
const SynonymsPostGame = ({
  ...
  return (
    <Fragment>
      <ConnectedTopBar
        RightComponent={<LeaderboardButton onPress={() => showLeaderboard(MODES.SYNONYMS)} />}
      />
      <ContentContainer>
...
export default SynonymsPostGame;
