...
const WORD_MARGIN_TOP = getSizingForOptions(14, 16, 18);
const WORD_MARGIN_BOTTOM = getSizingForOptions(12, 22, 28);
const WORD_PADDING_V = getSizingForOptions(8, 9, 10);
const WORD_PADDING_H = getSizingForOptions(28, 30, 32);
